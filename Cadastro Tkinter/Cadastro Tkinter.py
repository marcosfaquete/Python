...
class menu_cadastro:  # Criação da classe.
    ...
    def textomenu(self):  # Criação textos no menu.
        ...
        self.txt_estado_civil.place(relx=0.76, rely=0.15, relheight=0.05, relwidth=0.10)
    ...
    def entradadados(self):  # Criação dos campos da entrada de dados.
        ...
        self.entrada_radio_civil = Radiobutton(self.menu, text='Casado')
        self.entrada_radio_civil.place(relx=0.71, rely=0.19)

        self.entrada_radio_civil_02 = Radiobutton(self.menu, text='Solteiro')
        self.entrada_radio_civil_02.place(relx=0.82, rely=0.19)
        ...
        self.entrada_sexo = Radiobutton(self.menu, text='Masculino')
        self.entrada_sexo.place(relx=0.49, rely=0.26)

        self.entrada_sexo_2 = Radiobutton(self.menu, text='Feminino')
        self.entrada_sexo_2.place(relx=0.60, rely=0.26)
