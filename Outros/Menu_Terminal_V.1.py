...
while on == True:  # Enquanto variável (on) for verdadeira faça isso.
    ...
    if choice == 1:
        ...
        codigo = int(input('\033[34mCadastre um Código para o cliente: \033[m'))
        nome_1 = str(input('\033[34mNome do Cliente: \033[m'))
        data_nasc = str(input('\033[34mData de Nascimento: \033[m'))
        sexo = str(input('\033[34mSexo: \033[m'))
        endereco = str(input('\033[34mEndereço: \033[m'))
        celular = str(input('\033[34mCelular: \033[m'))
    ...
    # Se variável choice receber o número 2 faça isso.
        ...
        if finder == codigo:
            ...
            print('\033[34mCódigo do Cliente:\033[m {}'.format(codigo))
            print('\033[34mNome: \033[m{}'.format(nome_1.capitalize()))
            print('\033[34mData Nascimento: \033[m{}'.format(data_nasc))
            print('\033[34mSexo: \033[m{}'.format(sexo.capitalize()))
            print('\033[34mEndereço: \033[m{}'.format(endereco.capitalize()))
            print('\033[34mCelular:\033[m {}'.format(celular))
            time.sleep(1)
            ...
            cont2 = str(input('\033[35mDigite alguma tecla para continuar...\033[m\n'))
            print('\033[34mRetornando ao Menu Principal em\033[m \033[32m3\033[m')
            time.sleep(1)
            print('\033[34mRetornando ao Menu Principal em\033[m \033[33m2\033[m')
            time.sleep(1)
